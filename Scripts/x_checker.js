...
let mode = 'check';
let inputFile = path.join(__dirname, '..', 'Config', 'Users', 'users.txt');
...
const AUTH_FILE = path.join(__dirname, '..', 'Config', 'Settings', 'auth.json');
const COOKIES_FILE = path.join(__dirname, '..', 'Config', 'Cookies', 'cookies.txt');
const OUTPUT_FILE = path.join(__dirname, '..', 'TweetData', 'AccountStatus', 'results.csv');
